...
<marquee style="background-color: #ccc;" onmouseover="this.stop();" onmouseout="this.start();"><a class="nav-link" href="#">Only for testing !!! Not for other Purposes !!!!<?php echo $ro['mv_name']; ?></a></marquee>
